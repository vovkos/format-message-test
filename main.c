...
int main ()
{
	...
	langTable [] =
	{
		...
		{ MAKELANGID (LANG_INVARIANT, SUBLANG_DEFAULT),   L"LANG_INVARIANT, SUBLANG_DEFAULT" },
		{ MAKELANGID (LANG_INVARIANT, SUBLANG_SYS_DEFAULT), L"LANG_INVARIANT, SUBLANG_SYS_DEFAULT" },
		{ MAKELANGID (LANG_ENGLISH, SUBLANG_NEUTRAL),     L"LANG_ENGLISH, SUBLANG_NEUTRAL" },
		{ MAKELANGID (LANG_ENGLISH, SUBLANG_DEFAULT),     L"LANG_ENGLISH, SUBLANG_DEFAULT" },
		{ MAKELANGID (LANG_ENGLISH, SUBLANG_SYS_DEFAULT), L"LANG_ENGLISH, SUBLANG_SYS_DEFAULT" },
